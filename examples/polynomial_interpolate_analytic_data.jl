...
x = [i for i = 1 : 10]
y = 2 * (x - 1).^2 + 5
f_pol1 = Interpolation.polynomial_interpolate(x, y, deg=1)
f_pol2 = Interpolation.polynomial_interpolate(x, y, deg=2)
f_pol9 = Interpolation.polynomial_interpolate(x, y, deg=9)
